...
import { signUpSchema, signInSchema } from "@outdoor-game/types/src/validations/requests/auth"
...
export const signUp = async (req: Request, res: Response) => {
    ...
    validateSchema(req.body, signUpSchema, "SignUp input schema validation failed")
